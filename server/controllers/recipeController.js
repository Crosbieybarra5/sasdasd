...
exports.exploreRecipe = async(req, res) => {
  try {
    ...
    res.render('recipe', { title: 'RecipeBook - Recipes', recipe } );
  } catch (error) {
    res.status(500).send({message: error.message || "Error Occured" });
  }
} 
...
exports.searchRecipe = async(req, res) => {
  ...
  exports.exploreLatest = async(req, res) => {
    try {
      ...
      res.render('explore-latest', { title: 'Cooking Blog - Browse Recipes', recipe } );
    } catch (error) {
      res.status(500).send({message: error.message || "Error Occured" });
    }
  } 
  ...
  exports.submitRecipe = async(req, res) => {
    ...
    res.render('submit-recipe', { title: 'RecipeBook - Submit Recipe', infoErrorsObj, infoSubmitObj  } );
  }
